...
Elm.Xiangqi.make = function (_elm)
                   {
                     ...
                     var _op = {};
                     var rlift = F2(function (functions,c)
                                    {
                                      return A2(Signal._op["~"],functions,Signal.constant(c));
                                    });
                     ...
                     var inMoves = Native.Ports.portIn("inMoves",
                                                       Native.Ports.incomingSignal(function (v)
                                                                                   {
                                                                                     return typeof v === "object" && "legal" in v && "move" in v ? {_: {}, legal: typeof v.legal === "boolean" ? _J.toBool(v.legal) : _E.raise("invalid input, expecting JSBoolean but got " + v.legal), move: typeof v.move === "object" && "from" in v.move && "to" in v.move ? {_: {}, from: typeof v.move.from === "string" || typeof v.move.from === "object" && v.move.from instanceof String ? _J.toString(v.move.from) : _E.raise("invalid input, expecting JSString but got " + v.move.from), to: typeof v.move.to === "string" || typeof v.move.to === "object" && v.move.to instanceof String ? _J.toString(v.move.to) : _E.raise("invalid input, expecting JSString but got " + v.move.to)} : _E.raise("invalid input, expecting JSObject [\"from\",\"to\"] but got " + v.move)} : _E.raise("invalid input, expecting JSObject [\"legal\",\"move\"] but got " + v);
                                                                                   }));
                     ...
                     var inputs = {_: {}, color: color, moves: inMoves};
                     var outMoves = Native.Ports.portOut("outMoves",
                                                         Native.Ports.outgoingSignal(function (v)
                                                                                     {
                                                                                       return {from: _J.fromString(v.from), to: _J.fromString(v.to)};
                                                                                     }),
                                                         GameState.makeMoves(inputs));
                     var gameState = GameState.makeGame(inputs);
                     ...
                     var toDisplay = A3(Signal.lift2,
                                        ...
                                        boardCanvas,
                                        sidebar);
                     var main = A2(Signal._op["~"],inMiddle,toDisplay);
                     _elm.Xiangqi.values = {_op: _op, inputs: inputs, gameState: gameState, pieces2List: pieces2List, pieces: pieces, turn: turn, centeredContainer: centeredContainer, rlift: rlift, boardCanvas: boardCanvas, sidebar: sidebar, toDisplay: toDisplay, inMiddle: inMiddle, main: main};
                     return _elm.Xiangqi.values;
...
Elm.Sidebar.make = function (_elm)
                   {
                     ...
                     var updateStatus = F2(function ($new,prev)
                                           {
                                             return $new ? Connected : _U.eq(prev,
                                                                             Waiting) ? Waiting : _U.eq(prev,
                                                                                                        Connected) ? Disconnected : Disconnected;
                                           });
                     var whoseTurn = F2(function (player,turn)
                                        {
                                          return _U.eq(turn,player) ? "Your" : function ()
                                                                               {
                                                                                 switch (turn.ctor)
                                                                                 {case
                                                                                  "Black" :
                     ...
                     var putTogether = F2(function (turn,piece)
                                          {
                                            return A2(Graphics.Element.flow,
                                                      Graphics.Element.down,
                                                      _J.toList([rectSpacer,turn,piece]));
                                          });
                     var darkGrey = A3(Color.rgb,55,55,55);
                                                 ...
                                                 return function ()
                                                        {
                                                          ...
                                                          {case
                                                           "Black\'s" :
                                                             return A2(color,Color.black,text);
                                                           case
                                                           "Red\'s" :
                                                             return A2(color,Color.red,text);}
                                         ...
                                         return function ()
                                                {
                                                  ...
                                                  var phrase = _J.toList([name,ending]);
                                                  var asElts = A2(List.map,Text.text,phrase);
                                                  return A2(Graphics.Element.flow,
                                                            Graphics.Element.right,
                                                            asElts);
                                                }();
                                          ...
                                          return function ()
                                                 {
                                                   ...
                                                   {case
                                                    ...
                                                    "Waiting" :
                                                      return waiting;}
                                                   _E.Case($moduleName,"between lines 69 and 72");
                                                 }();
                                        });
                     ...
                     _elm.Sidebar.values = {_op: _op, color: color, darkGrey: darkGrey, spacerw: spacerw, squareSpacer: squareSpacer, rectSpacer: rectSpacer, whoseTurn: whoseTurn, applyColor: applyColor, turnMessage: turnMessage, makePieceView: makePieceView, putTogether: putTogether, makeTurnView: makeTurnView, waiting: waiting, disconnected: disconnected, makeTitle: makeTitle, updateStatus: updateStatus, makeSideBar: makeSideBar, Waiting: Waiting, Connected: Connected, Disconnected: Disconnected};
                     return _elm.Sidebar.values;
                   };Elm.Board = Elm.Board || {};
Elm.Board.make = function (_elm)
                 {
                   ...
                   var rmap = F2(function (functions,c)
                                 {
                                   return A2(List.map,
                                             function (f)
                                             {
                                     ...
                                     return function ()
                                            {
                                              ...
                                              {case
                                               ...
                                               "Soldier" :
                                                 return "soldier";}
                                              _E.Case($moduleName,"between lines 27 and 34");
                                            }();
                                   };
                   var pieceImage = F2(function (kind,color)
                                       {
                                         return function ()
                                                {
                                                                    ...
                                                                    return function ()
                                                                           {
                                                                             ...
                                                                             {case
                                                                              "Black" :
                                                                                return {ctor: "_Tuple2", _0: Constants.boardWidth - defaultWidth, _1: Constants.boardHeight - defaultHeight};
                                                                              case
                                                                              "Red" :
                                                                                return {ctor: "_Tuple2", _0: defaultWidth, _1: defaultHeight};}
                                                                             _E.Case($moduleName,
                   ...
                   var imageWithPieces = F2(function (pieces,turn)
                                            {
                                              return function ()
                                                     {
                                                       var pieceFns = A2(List.map,makePiece,pieces);
                                                       var finalPieces = A2(rmap,pieceFns,turn);
                                                       return {ctor: "::", _0: Graphics.Collage.toForm(Constants.boardImage), _1: finalPieces};
                                                     }();
                                            });
                   var makeBoard = F2(function (gameState,color)
                                      {
                                        return function ()
                                               {
                                                 var player = A2(Signal.lift,Model.playerADT,color);
                                                 var pieces = A2(Signal.lift,
                                                                 function (_)
                                                                 {
                                                                   return _.pieces;
                                                 ...
                                                 var realDisplay = A2(Signal.lift2,
                                                                      imageWithPieces,
                                                                      pieces)(player);
                                                 return A2(Signal.lift,collageBounds,realDisplay);
                                               }();
                                      });
                   _elm.Board.values = {_op: _op, tmap: tmap, toFloats: toFloats, translate2Pixels: translate2Pixels, initialMove: initialMove, pieceName: pieceName, pieceImage: pieceImage, pieceRadius: pieceRadius, makePiece: makePiece, rmap: rmap, imageWithPieces: imageWithPieces, edgeOffset: edgeOffset, collageBounds: collageBounds, makeBoard: makeBoard};
                   return _elm.Board.values;
...
Elm.GameState.make = function (_elm)
                     {
                       ...
                       var ParsedMove = F2(function (a,b)
                                           {
                                             return {_: {}, legal: a, move: b};
                                           });
                       var handleLegalMove = F2(function (_v1,state)
                                                {
                                                  return function ()
                                                         {
                                                           return function ()
                                                                  {
                                                                    ...
                                                                    var mightMove = A2(Model.findPiece,
                                                                                       pieces,
                                                                                       from);
                                                                    return Basics.not(_v1.legal) ? _U.replace([["moved",
                                                                                                                false]],
                                                                                                              state) : {_: {}, moved: true, pieces: A3(Moving.makeMove,
                                                                                                                                                       mightMove,
                                                                                                                                                       pieces,
                                                                                                                                                       to), selected: Maybe.Nothing, turn: toggleTurn(turn)};
                                                                  }();
                                                         }();
                                                });
                       var selectPiece = F2(function (state,clickPos)
                                            {
                                          ...
                                          return function ()
                                                 {
                                                   ...
                                                   {case
                                                    "_Tuple2" :
                                                      return {_: {}, from: Parser.pos2String(_v3._0), to: Parser.pos2String(_v3._1)};}
                                                   _E.Case($moduleName,
                       ...
                       var initialMove = {ctor: "_Tuple2", _0: {ctor: "_Tuple2", _0: _U.chr("h"), _1: 11}, _1: {ctor: "_Tuple2", _0: _U.chr("h"), _1: 11}};
                       var initialConfirmation = {_: {}, legal: false, move: encodeMove(initialMove)};
                       var updateMove = F2(function (position,_v7)
                                           {
                                             return function ()
                                                    {
                                                      switch (_v7.ctor)
                                                      {case
                                                       "_Tuple2" :
                                                         return {ctor: "_Tuple2", _0: _v7._1, _1: position};}
                                                      _E.Case($moduleName,
                                                              "on line 23, column 35 to 47");
                                                    }();
                                           });
                       var choosePos = F3(function (player,redPos,blackPos)
                                          {
                                            return function ()
                                                   {
                                                     switch (player.ctor)
                                                     {case
                                                      ...
                                                      "Red" :
                                                        return redPos;}
                                                     _E.Case($moduleName,"between lines 18 and 20");
                                                   }();
                                          });
                       ...
                       var makeMoves = function (_v12)
                                       {
                                         return function ()
                                                {
                                                  return function ()
                                                         {
                                                           var clickPosition = makeClicks(_v12.color);
                       ...
                       var initialState = {_: {}, moved: false, pieces: Model.allPieces, selected: Maybe.Nothing, turn: Model.Red};
                       var makeGame = function (_v14)
                                      {
                                        return function ()
                                               {
                                                 return function ()
                       ...
                       _elm.GameState.values = {_op: _op, initialState: initialState, choosePos: choosePos, updateMove: updateMove, initialMove: initialMove, initialConfirmation: initialConfirmation, stail: stail, encodeMove: encodeMove, makeClicks: makeClicks, makeMoves: makeMoves, selectPiece: selectPiece, handleLegalMove: handleLegalMove, convertMoveRecord: convertMoveRecord, toggleTurn: toggleTurn, makeGame: makeGame, ParsedMove: ParsedMove};
                       return _elm.GameState.values;
...
Elm.Parser.make = function (_elm)
                  {
                                        ...
                                        return function ()
                                               {
                                                 ...
                                                 {case
                                                  ...
                                                  "Red" :
                                                    return "red";}
                                                 _E.Case($moduleName,"between lines 76 and 78");
                                               }();
                                      };
                                        ...
                                        return function ()
                                               {
                                                 ...
                                                 {case
                                                  ...
                                                  "Soldier" :
                                                    return "Soldier";}
                                                 _E.Case($moduleName,"between lines 66 and 73");
                                               }();
                                      };
                                   ...
                                   return function ()
                                          {
                                            ...
                                            {case
                                             ...
                                             "Nothing" :
                                               return -1;}
                                            _E.Case($moduleName,"between lines 26 and 28");
                                          }();
                                 };
                    var chars2Pos = function (chars)
                                    {
                                      return function ()
                                             {
                                               var numStr = String.fromList(A2(List.drop,2,chars));
                                               var number = unpack(String.toInt(numStr));
                                               var colStr = String.fromList(A2(List.take,1,chars));
                                               var col = unpack(String.toInt(colStr));
                                               var $char = Constants.num2Char(col);
                                               return {ctor: "_Tuple2", _0: $char, _1: number + 1};
                                             }();
                                    };
                                       ...
                                       return function ()
                                              {
                                                ...
                                                _E.Case($moduleName,"between lines 60 and 63");
                                              }();
                                     };
                    ...
                    var Metadata = F2(function (a,b)
                                      {
                                        return {_: {}, gameId: a, player: b};
                                      });
                    _elm.Parser.values = {_op: _op, decodeMove: decodeMove, pos2String: pos2String, unpack: unpack, chars2Pos: chars2Pos, string2Pos: string2Pos, int2Str: int2Str, piece2List: piece2List, type2String: type2String, encodeColor: encodeColor, Metadata: Metadata};
                    return _elm.Parser.values;
...
Elm.Moving.make = function (_elm)
                  {
                    ...
                    var Time = Elm.Time.make(_elm);
                    var _op = {};
                    var remove = F2(function (list,element)
                                    {
                                      return A2(List.filter,
                                                function (e)
                                                {
                                                  return Basics.not(_U.eq(e,element));
                                                },
                                                list);
                                    });
                                                ...
                                                return function ()
                                                       {
                                                         ...
                                                         return {ctor: "::", _0: newPiece, _1: removeCaptured};
                                                       }();}
                                             break;}
                                          _E.Case($moduleName,"between lines 13 and 19");
                                        }();
                               };
                    var makeMove = F3(function (option,pieces,position)
                                      {
                                        return function ()
                                               {
                                                 switch (option.ctor)
                                                 {case
                                                  "Just" :
                                                    return move({ctor: "_Tuple3", _0: option._0, _1: pieces, _2: position});
                                                  case
                                                  "Nothing" :
                                                    return pieces;}
                                                 _E.Case($moduleName,"between lines 24 and 27");
                                               }();
                                      });
                    _elm.Moving.values = {_op: _op, remove: remove, move: move, makeMove: makeMove};
                    return _elm.Moving.values;
                  };Elm.Input = Elm.Input || {};
Elm.Input.make = function (_elm)
                 {
                   ...
                   var _op = {};
                   var widthOffset = 20;
                   var toBoardColumn = F2(function (player,pixels)
                                          {
                                            return function ()
                                                   {
                                                     switch (player.ctor)
                                                     {case
                                                      ...
                                                      "Red" :
                                                        return Constants.num2Char(A2(Basics.div,
                                                                                     pixels + widthOffset,
                                                                                     Constants.squareSize));}
                                                     _E.Case($moduleName,"between lines 24 and 28");
                                                   }();
                                          });
                   var heightOffset = 12;
                   var toBoardRow = F2(function (player,pixels)
                                       {
                                         return function ()
                                                {
                                                  switch (player.ctor)
                                                  ...
                                                  _E.Case($moduleName,"between lines 16 and 22");
                                                }();
                                       });
                   var toBoardPosition = F2(function (player,_v2)
                                            {
                                              return function ()
                                                     {
                                                       switch (_v2.ctor)
                                                       {case
                                                        "_Tuple2" :
                                                          return {ctor: "_Tuple2", _0: A2(toBoardColumn,
                                                                                          player,
                                                                                          _v2._0), _1: A2(toBoardRow,
                                                                                                          player,
                                                                                                          _v2._1)};}
                                                       _E.Case($moduleName,
                   ...
                   var toBoardPixels = F3(function (_v6,w,h)
                                          {
                                            return function ()
                                                   {
                                                     switch (_v6.ctor)
                                                        ...
                                                        return function ()
                                                               {
                                                                 ...
                                                                 return {ctor: "_Tuple2", _0: _v6._0 - xToBoard, _1: _v6._1 - yToBoard};
                                                               }();}
                                                     _E.Case($moduleName,"between lines 8 and 10");
                                                   }();
                                          });
                   ...
                   var blackBoardPosition = A2(Signal.lift,
                                               ...
                                               boardPixels);
                   _elm.Input.values = {_op: _op, redBoardPosition: redBoardPosition, blackBoardPosition: blackBoardPosition};
                   return _elm.Input.values;
                 };Elm.Model = Elm.Model || {};
Elm.Model.make = function (_elm)
                 {
                   ...
                   var State = F4(function (a,b,c,d)
                                  {
                                    return {_: {}, moved: d, pieces: b, selected: c, turn: a};
                                  });
                   var Piece = F3(function (a,b,c)
                                  {
                                    return {ctor: "Piece", _0: a, _1: b, _2: c};
                                  });
                   var findPiece = F2(function (pieces,position)
                                      {
                                        return function ()
                                               {
                                                 switch (pieces.ctor)
                                               ...
                                               "Piece" :
                                                 ...
                                                 {case
                                                  "_Tuple2" :
                                                    return A3(Piece,
                                                              _v6._0,
                                                              {ctor: "_Tuple2", _0: _v6._1._0, _1: 11 - _v6._1._1},
                                                              Black);}
                                                 break;}
                                              _E.Case($moduleName,"on line 31, column 39 to 71");
                                            }();
                                   };
                   var Red = {ctor: "Red"};
                                 ...
                                 return function ()
                                        {
                                          ...
                                          {case
                                           "_Tuple2" :
                                             return A3(Piece,
                                                       _v13._0,
                                                       {ctor: "_Tuple2", _0: _v13._1, _1: 1},
                                                       Red);}
                                          _E.Case($moduleName,"on line 26, column 22 to 46");
                                        }();
                               };
                   ...
                   var cannons = A2(List.map,
                                    function (c)
                                    {
                                      return A3(Piece,Cannon,{ctor: "_Tuple2", _0: c, _1: 3},Red);
                                    },
                                    _J.toList([_U.chr("b"),_U.chr("h")]));
                   var Horse = {ctor: "Horse"};
                   var Elephant = {ctor: "Elephant"};
                   var Advisor = {ctor: "Advisor"};
                   var typeOrder = _J.toList([Chariot,Horse,Elephant,Advisor]);
                   var fullTypes = List.concat(_J.toList([typeOrder,
                                                          {ctor: "::", _0: King, _1: List.reverse(typeOrder)}]));
                   var typesWithChars = A2(List.zip,fullTypes,Constants.allLetters);
                   var rest = A2(List.map,piece,typesWithChars);
                   var Soldier = {ctor: "Soldier"};
                   var soldier = function ($char)
                                 {
                                   return A3(Piece,Soldier,{ctor: "_Tuple2", _0: $char, _1: 4},Red);
                                 };
                   var soldiers = A2(List.map,soldier,Constants.soldierLetters);
                   var redPieces = List.concat(_J.toList([soldiers,cannons,rest]));
                   var blackPieces = A2(List.map,makeBlack,redPieces);
                   var allPieces = List.concat(_J.toList([redPieces,blackPieces]));
                   _elm.Model.values = {_op: _op, soldier: soldier, soldiers: soldiers, cannons: cannons, typeOrder: typeOrder, fullTypes: fullTypes, typesWithChars: typesWithChars, piece: piece, rest: rest, redPieces: redPieces, makeBlack: makeBlack, blackPieces: blackPieces, allPieces: allPieces, findPiece: findPiece, playerADT: playerADT, Soldier: Soldier, Advisor: Advisor, Elephant: Elephant, Horse: Horse, Cannon: Cannon, Chariot: Chariot, King: King, Red: Red, Black: Black, Piece: Piece, State: State};
                   return _elm.Model.values;
...
Elm.Constants.make = function (_elm)
                     {
                       ...
                       var range = F2(function (min,max)
                                      {
                                        return _U.cmp(min,
                                                      max) < 0 ? {ctor: "::", _0: min, _1: A2(range,
                                                                                              min + 1,
                                                                                              max)} : _J.toList([]);
                                      });
                       ...
                       var twoThirds = function (x)
                                       {
                                         return x - A2(Basics.div,x,3);
                                       };
                       var folder = "assets";
                       var imageName = _L.append(folder,"/board.jpg");
                       var imageFileSize = _J.toList([669,749]);
                       var boardSize = A2(List.map,twoThirds,imageFileSize);
                       var $ = boardSize;
                                            ...
                                            "::" :
                                              ...
                                              {case
                                               "::" :
                                                 ...
                                                 break;}
                                              break;}
                                           _E.Case($moduleName,"on line 16, column 29 to 38");
                                         }();
                       ...
                       var boardImage = A3(Graphics.Element.image,
                                           ...
                                           boardHeight,
                                           imageName);
                       var squareSize = A2(Basics.div,boardWidth,8);
                       var $ = A2(List.map,half,boardSize);
                                             ...
                                             "::" :
                                               ...
                                               {case
                                                "::" :
                                                  ...
                                                  break;}
                                               break;}
                                            _E.Case($moduleName,"on line 18, column 31 to 49");
                                          }();
                       ...
                       _elm.Constants.values = {_op: _op, sideBarWidth: sideBarWidth, imageFileSize: imageFileSize, folder: folder, imageName: imageName, twoThirds: twoThirds, half: half, boardSize: boardSize, boardHeight: boardHeight, boardWidth: boardWidth, boardImage: boardImage, centerHeight: centerHeight, centerWidth: centerWidth, squareSize: squareSize, char2Num: char2Num, num2Char: num2Char, allRows: allRows, range: range, allColumns: allColumns, allLetters: allLetters, soldierLetters: soldierLetters};
                       return _elm.Constants.values;
                     };Elm.Monad = Elm.Monad || {};
Elm.Monad.make = function (_elm)
                 {
                   ...
                   var Time = Elm.Time.make(_elm);
                   var _op = {};
                   var flatmap = F2(function (fn,monad)
                                    {
                                      return function ()
                                             {
                                               switch (monad.ctor)
                                               {case
                                                ...
                                                "Nothing" :
                                                  return Maybe.Nothing;}
                                               _E.Case($moduleName,"between lines 16 and 18");
                                             }();
                                    });
                   var filter = F2(function (fn,monad)
                                   {
                                     return function ()
                                            {
                                              switch (monad.ctor)
                                              {case
                                               ...
                                               "Nothing" :
                                                 return Maybe.Nothing;}
                                              _E.Case($moduleName,"between lines 10 and 12");
                                            }();
                                   });
                   var map = F2(function (fn,monad)
                                {
                                  return A2(flatmap,
                                            function (v)
                                            {
                   ...
                   _elm.Monad.values = {_op: _op, map: map, filter: filter, flatmap: flatmap};
                   return _elm.Monad.values;
                 };
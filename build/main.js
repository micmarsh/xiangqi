...
(function (global){// Generated by CoffeeScript 1.7.1
(function() {
  var System;
  ...
  System.create('legality', (function() {
    ...
    return function(_arg, sender, self) {
      var check, data, legal, move, pieces, turn, type;
  ...
  System.create('master', (function() {
    var app, event, _fn, _i, _len, _ref;
    ...
    _fn = function(event) {
      return window["on" + event] = function() {
        var online;
        online = event === 'online';
        return app.ports.connected.send(online);
      };
    };
    ...
    return function(message, s, self) {
      ...
      switch (type) {
        case 'check':
          return app.ports.check.send(data);
        case 'move':

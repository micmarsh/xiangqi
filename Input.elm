module Input (boardPosition) where
...
toBoardPosition (x, y) = (toBoardColumn Red x, toBoardRow Red y)

boardPosition = lift toBoardPosition boardPixels
